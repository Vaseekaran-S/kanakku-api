...
const { createNewAccount, getAccount, updateAccount, deleteAccount, getAllAccounts, getUserAccounts, deleteAllAccount, getUserAccountByName, changeAccountType, getUserPortfolio } = require("../controllers/accounts.controller");
